...
#
$global:ServerIP 	= "192.168.1.9"                     ##### Server IP: Transfer, Processing, Picture and Archive directories
#
# Database settings:
#
# read password from file:
$SQL_PWFILE 		= "C:\ImageTransfer\password.txt"   ##### File containing Password for login to SQL database
$SQL_USER 			= "dbo_smns"                        ##### User name for login to SQL database
$SQL_PASSWORD 		= ""                                ##### Password will be set later on from Password file content
$SQL_COMMAND_PROG 	= "sqlcmd"
$SQL_SERVER 		= "smns.diversityworkbench.de,5432" ##### Server IP: SQL database server
$SQL_DATABASE_NAME 	= "DiversityCollection_SMNS"        ##### Preset Collection database name
$SQL_PROJECTS_DATABASE_NAME = "DiversityProjects_SMNS"  ##### Preset Projects database name
#
...
#
$WebServer 			= 'pictures.smns-bw.org'              ##### Web address of picture server
$WebServerMedia  	= 'media.smns-bw.org'                 ##### Web address of other media server
#
# Set constants
#
$UNDERSCORE = "_"
...
# 
$DIFF_PROC_EXE 		= 'C:/cygwin64/bin/diff.exe'
#
...
#
$CONVERT_PROG_EXE 	= 'C:\Program Files\ImageMagick-7.0.10-Q16-HDRI/magick.exe'
...
#
# ========= neu ==========
$global:WebServerRootPath 	= '//$global:ServerIP/pictures'
...
function CheckValidFileName( [string] $MyOriginalFileName )
{
	...
	if ( $global:extString -eq ".tif" -or $global:extString -eq ".tiff" -or  $global:extString -eq ".jpg" -or  $global:extString -eq ".png" )
	{
		$global:DoImageConversion = $IMAGE_CONVERSION_FLAG
		$global:webExtString = ".jpg"
		$global:WebServerRootPath 	= '/pictures'
		$global:IsMediaFile = $false
	}
	elseif ( $global:extString -eq ".wav" -or $global:extString -eq ".mp3" -or $global:extString -eq ".mp4" )
	{
		...
		$global:WebServerRootPath 	= '/media'
